...
class _FakeModel:
    ...
    def infer_action(self, prompt, input_image, action_horizon, **_kwargs):
        del prompt, input_image, action_horizon
...
def _build_policy_with_seed(
    ...
    import fastwam.inference.policy as policy_module
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with (
            ...
            mock.patch.object(policy_module, "instantiate", side_effect=instantiate),
            mock.patch.object(policy_module, "OmegaConf", _OmegaConfStub),
        ):
            return policy_module.load_policy_from_run(
                run_dir=run_dir,
