...
SOURCE_CONFIG="${SOURCE_CONFIG:-${ROOT_DIR}/configs/eval/dexjoco/mixed_5task_fastwam_joint/config.yaml}"
...
# Paths / VAE / text cache only. CFG mixing is DEWO v9 in scripts/train_dexjoco.py
...
log "  python scripts/train_dexjoco.py --task-name ${TASK} --init s0 --env-file ${env_file} --gpus <ids>"
