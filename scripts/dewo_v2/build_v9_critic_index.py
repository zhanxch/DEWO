...
def build_index(
    ...
    *,
    ...
    for i, o in sorted(outcomes.items()):
        ...
        if rec["success"]:
            rec["train_eligible"] = is_train_success(
                o, rec["length"], task_name=task_name
            )
    ...
    return {
        ...
        "counts": {
            ...
            "env_success_over_train_cap": len(over_cap),
        ...
        "length_stats": {
            ...
            "env_success_over_train_cap_len": _stats([x["length"] for x in over_cap]),
        ...
        "env_success_over_train_cap": over_cap,
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--task-name",
        default=None,
        help="Task id for prepare train-success length cap (hammer_nail only).",
    )
